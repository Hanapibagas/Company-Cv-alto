                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="article-image text-center">
                            <img src="{{ asset('storage/'.$networkings->image) }}" alt="image"
                    ...
                    <div class="col-md-5">
                        <div class="">
                            ...
                            <br>
                            <p style="font-size:30px; font-weight:bold; color:black;">Rp. {{ $networkings->price }} </p>
                            <a href="https://wa.me/6282192272289?text=Hallo Liny Jaya... Saya ingin order produk *WINDOWS 10 PRO* *Harga : Rp. 250,000*"
